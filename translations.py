...
TRANSLATIONS = {
    ...
    "es": {
        # Log messages
        "starting_script": "Iniciando código email2print",
        ...
        "email_marked_deletion": "Correo {uid} marcado para eliminación.",
        ...
        # Confirmation email
        "confirmation_subject_default": "Confirmación del trabajo de impresión",
        "confirmation_processed": "El trabajo de impresión fue procesado:\n\n{log}",
        "confirmation_printed": "{timestamp} – El archivo '{filename}' fue impreso en la impresora '{printer}'",
